 ...
 *  MotionController_Init(), Communication_Init(), StatusReporter_Init() 호출.
 ...
 * -> MotionController_Process() -> Motor_Process() -> StatusReporter_Process()
 * -> AppTest_Process() 순서로 각 모듈의 Process를 호출한다.
