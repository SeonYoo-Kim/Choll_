...
| [DEVELOPMENT_GUIDE.md](DEVELOPMENT_GUIDE.md) | 코딩 규칙·아키텍처 원칙·주차별 TODO | 규칙 (HOW) |
...
- 주차별 진행 상태는 DEVELOPMENT_GUIDE.md의 TODO와 README의 Current Progress 두 곳에 있다 — 한쪽만 고치지 말 것.
