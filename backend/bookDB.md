...
| 책장 번호 | 존 | 분류 | 분류 범위 | 소장본 수 |
|---|---|---|---:|---:|
| 000 | Z1 | 총류 | 000.00000 ~ 099.99999 | 1,825 |
| 100 | Z2 | 철학 | 100.00000 ~ 199.99999 | 3,817 |
| 200 | Z2 | 종교 | 200.00000 ~ 299.99999 | 1,312 |
| 300 | Z3 | 사회과학 | 300.00000 ~ 399.99999 | 10,370 |
| 400 | Z3 | 자연과학 | 400.00000 ~ 499.99999 | 3,857 |
| 500 | Z4 | 기술과학 | 500.00000 ~ 599.99999 | 5,277 |
| 600 | Z5 | 예술 | 600.00000 ~ 699.99999 | 2,558 |
| 700 | Z6 | 언어 | 700.00000 ~ 799.99999 | 2,427 |
| 800 | Z6 | 문학 | 800.00000 ~ 899.99999 | 30,809 |
| 900 | Z7 | 역사 | 900.00000 ~ 999.99999 | 5,037 |
...
중앙 통로 `x=450~550`과 책장 설치 공간은 어떤 존의 다각형에도 포함하지 않습니다.
현재 다각형은 `1000×600` 테스트 지도 이미지 좌표이며 실제 로봇 좌표로 사용하려면
SLAM 지도 기준 좌표 변환 또는 실측 좌표 반영이 필요합니다.
...
| 카트 연결 상태 | `ONLINE` |
| 카트 동작 상태 | `IDLE` |
| 카트 좌표와 현재 구역 | `(180, 140)`, `Z1` |
| 슬롯 번호 | 1 ~ 30 |
| 슬롯 상태 | 모두 `EMPTY` |
| 슬롯의 소장 도서 | 모두 `NULL` |
| RFID | Z2 도서 2권, Z6 도서 3권에 테스트 UID 등록 |
...
덤프에는 도서 66,411종, 소장 도서 67,289권, `Z1~Z7`, KDC 테스트 책장,
테스트 RFID 도서 5권, 카트 1대, 슬롯 30개가 포함되어 있습니다.
DB 비밀번호나 `.env` 값은 포함하지 않습니다.
