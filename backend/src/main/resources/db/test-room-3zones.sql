...
-- 용도는 **카트 현재 구역 판정 하나**입니다 (LED·정리 대상 계산의 기준.
--   목적지 좌표는 BE가 스냅 없이 그대로 하행하므로 폴리곤과 무관합니다).
-- 존끼리 겹치지 않게 할 것: ZoneLocator가 첫 매칭을 쓰므로 겹치면 판정이 임의가 됩니다.
-- code는 FE zones.ts의 ZONE_CODES(Z1·Z2·Z3)와 정확히 같아야 id 조인이 됩니다.
SET @z1_polygon = '[[827,128],[989,128],[989,582],[827,582]]';  -- 우측 통로 (000 총류 서가 앞)
SET @z2_polygon = '[[450,128],[631,128],[631,582],[450,582]]';  -- 중앙 통로 (100 철학·200 종교 앞)
SET @z3_polygon = '[[10,128],[255,128],[255,582],[10,582]]';    -- 좌측 통로 (800 문학 서가 앞)

-- 책장 위치 — 평면도의 어두운 서가 면 중심 (1000x600 픽셀, 캔버스 픽셀 스캔 실측).
-- SLAM 실측 기반 신판 평면도(2026-08-07) 기준. 좌→우로 800 · 200 | 통로 | 100 · 000 순서이고
-- 네 면의 y는 같습니다 (블록 y 263~393의 중심 328).
SET @shelf_000_x = 772.000000; SET @shelf_000_y = 328.000000;
SET @shelf_100_x = 685.000000; SET @shelf_100_y = 328.000000;
SET @shelf_200_x = 396.000000; SET @shelf_200_y = 328.000000;
SET @shelf_800_x = 309.000000; SET @shelf_800_y = 328.000000;
